...
export class News extends React.Component<RouteComponentProps<{}>, FetchDataState> {
    ...
    getNewsPanel(article: ArticleData) {
		...
		const headingStyle = {
				...
				whiteSpace: "normal",
				backgroundColor: article.resource.color1,
				borderColor: article.resource.highlight,
				color: article.resource.color2
			},
			titleStyle = {
				maxHeight: "6.0em",
				//overflow: "hidden",
			...
			bodyStyle = {
				color: article.resource.color1,
				backgroundColor: article.resource.color3,
				height: "fit-content"
			},
			buttonStyle = {
				maxHeight: "200px",
				...
				whiteSpace: "normal",
				width: "100%",
				backgroundColor: article.resource.color2,
				borderColor: article.resource.highlight,
				color: article.resource.color1
			},
			credentialsStyle = {
